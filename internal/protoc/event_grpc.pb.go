...
const (
	EventService_SubmitEvent_FullMethodName = "/beacon.EventService/SubmitEvent"
)
...
func (c *eventServiceClient) SubmitEvent(ctx context.Context, in *SubmitEventRequest, opts ...grpc.CallOption) (*SubmitEventResponse, error) {
...
func (UnimplementedEventServiceServer) SubmitEvent(context.Context, *SubmitEventRequest) (*SubmitEventResponse, error) {
...
func _EventService_SubmitEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).SubmitEvent(ctx, req.(*SubmitEventRequest))
	}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "beacon.EventService",
